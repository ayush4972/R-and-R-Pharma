...
export default function Contact() {
  ...
  return (
    <div className="pb-stack-lg max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop min-h-screen pt-stack-lg">
      {/* Page Header */}
      <section className="mb-stack-lg">
        <h1 className="font-display-lg text-headline-lg md:text-display-lg font-bold text-on-surface mb-stack-sm">Contact Us</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
        {/* Left: Contact Form */}
        <div className="lg:col-span-7 bg-surface-container-lowest border border-outline-variant p-stack-lg rounded-xl shadow-soft">
          ...
          <form className="space-y-stack-md" onSubmit={handleSubmit}>
            ...
            <div className="pt-stack-sm">
              <button
                className="btn-lift w-full md:w-auto bg-primary hover:bg-primary-container text-on-primary px-margin-mobile md:px-margin-desktop py-4 rounded-lg font-label-md text-label-md uppercase tracking-wider disabled:opacity-70 disabled:cursor-not-allowed"
                type="submit"
                disabled={isLoading}
              >
        ...
        <div className="lg:col-span-5 space-y-gutter">
          <div className="card-lift bg-surface-container border border-outline-variant p-stack-lg rounded-xl">
            <h2 className="font-headline-md text-headline-md text-on-surface mb-stack-lg">
              Contact Information
            </h2>
          ...
          {/* Operating Hours */}
          <div className="card-lift bg-surface-container-low border border-outline-variant p-stack-lg rounded-xl">
